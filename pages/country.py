...
layout = dbc.Container([
    dbc.Row ([
        dbc.Col(
                html.Div([
                html.H1("Подробная информация о выбранной стране"),
                html.H5("Выберите континент и интересующую Вас страну"),
    ...
    html.Br(),
        ...
        dbc.Row ([
            dbc.Col([ dbc.Card([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dbc.CardImg(src='/static/images/images/money.png')], width= 4),
                        dbc.Col([
                            dbc.CardBody([
                                html.P(
                                id='card_text1',
            ...
            dbc.Col([ dbc.Card([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dbc.CardImg(src='/static/images/images/religious.png')], width= 4),
                        dbc.Col([
                            dbc.CardBody([
                                html.P(
                                id='card_text2',
            ...
            dbc.Col([ dbc.Card([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dbc.CardImg(src='/static/images/images/diploma.png')], width= 4),
                        dbc.Col([
                            dbc.CardBody([
                                html.P(
                                id='card_text3',
            ...
            dbc.Col([ dbc.Card([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dbc.CardImg(src='/static/images/images/globe.png')], width= 4),
                        dbc.Col([
                            dbc.CardBody([
                                html.P(
                                id='card_text4',
